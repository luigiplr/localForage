(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define('asyncStorage', ['module', 'exports', '../utils/createBlob', '../utils/idb', '../utils/promise', '../utils/executeCallback', '../utils/executeTwoCallbacks'], factory);
    } else if (typeof exports !== "undefined") {
        factory(module, exports, require('../utils/createBlob'), require('../utils/idb'), require('../utils/promise'), require('../utils/executeCallback'), require('../utils/executeTwoCallbacks'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod, mod.exports, global.createBlob, global.idb, global.promise, global.executeCallback, global.executeTwoCallbacks);
        global.asyncStorage = mod.exports;
    }
})(this, function (module, exports, _createBlob, _idb, _promise, _executeCallback, _executeTwoCallbacks) {
    'use strict';
